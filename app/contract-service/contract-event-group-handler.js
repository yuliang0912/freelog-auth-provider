...
module.exports = {
    ...
    async EventGroupHandler(contractInfo, compoundEvent, subEventId, ...otherArgs){
        ...
        let envetGroup = await eggApp.provider.contractEventGroupProvider.getEventGroup(condition)
        ...
        await eggApp.provider.contractEventGroupProvider.updateEventGroup(condition, {
