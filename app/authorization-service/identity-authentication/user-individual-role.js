...
module.exports = class UserIndividualRoleAuthHandler {
     ...
     */
    handle({authUserObject, partyOneUserId, partyTwoUserInfo}) {
        ...
        if (!partyTwoUserInfo || !partyTwoUserInfo.userId) {
            throw new ArgumentError('user-individual-role-params-validate-failed: partyTwoUserInfo', {partyTwoUserInfo})
        }
